...
e deixa o próximo número em 2. Interrompe a operação se não existir exactamente
um recibo com o número esperado. Não altera cópias já enviadas/impressas e não
faz parte das migrações automáticas.
